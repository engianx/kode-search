...
def main():
    ...
    parser.add_argument('--zip', action='store_true', default=True, help='Zip the intermidiate files.')
    ...
    parser.add_argument('--embedding-type', choices=['summary', 'code', 'summary_and_code'], default='summary', help='Type of the embedding.')
    ...
    parser.add_argument('query', nargs=argparse.REMAINDER, metavar='ARGS', help='Search query (if any).')
